...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:10807", "127.0.0.1", 10807));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10807", "127.0.0.1", 10807));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10807", "::ffff:127.0.0.1", 10807));
    BOOST_CHECK(TestSplitHost("[::]:10807", "::", 10807));
    BOOST_CHECK(TestSplitHost("::10807", "::10807", -1));
    BOOST_CHECK(TestSplitHost(":10807", "", 10807));
    BOOST_CHECK(TestSplitHost("[]:10807", "", 10807));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10807", "127.0.0.1:10807"));
...
BOOST_AUTO_TEST_CASE(subnet_test)
{
    ...
    // All-Matching IPv6 Matches uvctrary IPv4 and IPv6
