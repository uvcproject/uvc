...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Uvc features */
        {"uvc", "masternode", &masternode, true, true, false},
        {"uvc", "listmasternodes", &listmasternodes, true, true, false},
        {"uvc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"uvc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"uvc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"uvc", "masternodedebug", &masternodedebug, true, true, false},
        {"uvc", "startmasternode", &startmasternode, true, true, false},
        {"uvc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"uvc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"uvc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"uvc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"uvc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"uvc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"uvc", "mnbudget", &mnbudget, true, true, false},
        {"uvc", "preparebudget", &preparebudget, true, true, false},
        {"uvc", "submitbudget", &submitbudget, true, true, false},
        {"uvc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"uvc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"uvc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"uvc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"uvc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"uvc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"uvc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"uvc", "checkbudgets", &checkbudgets, true, true, false},
        {"uvc", "mnsync", &mnsync, true, true, false},
        {"uvc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> uvc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:40809/\n";
}
