                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UVC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UVC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and uvc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UVC Core"), this);
    aboutAction->setStatusTip(tr("Show information about UVC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Uvc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UVC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UVC addresses"));
    ...
    openAction->setStatusTip(tr("Open a uvc: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UVC Core help message to get a list with possible Uvc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("UVC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Uvc network", "", count));
}
...
{
    QString strTitle = tr("UVC Core"); // default title
