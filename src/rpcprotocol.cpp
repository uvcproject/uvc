...
string HTTPPost(const string& strMsg, const map<string, string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: uvc-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
/**
 * JSON-RPC protocol.  Uvc speaks version 1.0 for maximum compatibility,
...
/** Username used when cookie authentication is in use (uvctrary, only for
