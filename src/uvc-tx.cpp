...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("UVC Core uvc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  uvc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded uvc transaction") + "\n" +
                               "  uvc-tx [options] -create [commands]   " + _("Create hex-encoded uvc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded uvc transaction
