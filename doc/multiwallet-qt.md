...
In order to support loading of multiple wallets in sprout-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sprout.cpp.
...
Changes to sprout.cpp
----------------------
sprout.cpp is the entry point into sprout-qt, and as such, will require some minor modifications to provide hooks for
...
The string parameter is just an sprouttrary name given to the default wallet. It's been prepended with a tilde to avoid name collisions in the future with additional wallets.
