...
This mechanism has been integrated into Bitcore-Node-Sprout which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sprout/insight-api-sprout#web-socket-api](https://github.com/sprout/insight-api-sprout#web-socket-api)
* API: [https://github.com/sprout/insight-api-sprout#swifttx-transactions](https://github.com/sprout/insight-api-sprout#swifttx-transactions)
...
By default, the Sprout Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sprout Core daemon:
