...
Intro
-----
Sprout (SPROUT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Sprout utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run sprout-qt.exe.

Sprout Core is the original Sprout client and it builds the backbone of the network.
However, it downloads and stores the entire history of Sprout transactions;
