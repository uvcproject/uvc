...
#   c) node1 mines 32 blocks, so now node 0 has 500000SPROUT, node 1 has 4250SPROUT, node2 has none.
#   d) node0 sends 601 SPROUT to node2, in two transactions (301 SPROUT, then 300 SPROUT).
