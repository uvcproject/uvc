Contributing to Sprout Core
==================================

The Sprout Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Sprout Core project, and is not to be
confused with overall Sprout Network Protocol consensus changes.

Whether a pull request is merged into Sprout Core rests with the project merge
...
Patches that change Sprout consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sprout consensus, it must have been
...
The project leader is the release manager for each Sprout Core release.
