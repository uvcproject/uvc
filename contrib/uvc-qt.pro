...
RESOURCES += src/qt/sprout.qrc src/qt/sprout_locale.qrc

TRANSLATIONS += src/qt/locale/sprout_bg.ts \
                src/qt/locale/sprout_de.ts \
                src/qt/locale/sprout_en.ts \
                src/qt/locale/sprout_es.ts \
                src/qt/locale/sprout_fi.ts \
                src/qt/locale/sprout_fr.ts \
                src/qt/locale/sprout_it.ts \
                src/qt/locale/sprout_ja.ts \
                src/qt/locale/sprout_pl.ts \
                src/qt/locale/sprout_pt.ts \
                src/qt/locale/sprout_ru.ts \
                src/qt/locale/sprout_sk.ts \
                src/qt/locale/sprout_sv.ts \
                src/qt/locale/sprout_vi.ts \
                src/qt/locale/sprout_zh_CN.ts \
                src/qt/locale/sprout_zh_TW.ts
